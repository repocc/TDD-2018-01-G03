...
error_reporting(E_ERROR | E_WARNING | E_PARSE);
	...
	class cnnMySql
	{
		...
		\******************************************************************/
		/*******************************************\
		|DEFINO LAS PORPIEDADES P�BLICAS DE LA CLASE|
		\*******************************************/
		/****************************************************************************\
		...
		/**********************************************************************\
		|CONTIENE EL NOMBRE DE USUARIO PARA LA CONEXI�N CONTRA LA BASE DE DATOS|
		\**********************************************************************/
		private $usuario        = "nahue";
		/********************************************************************************\
		|CONTIENE EL NOMBRE DE LA BASE DE DATOS A LA QUE APUNTAREMOS CON NUESTRA CONEXI�N|
		\********************************************************************************/
		private $baseDato       = "Ticket_system";
		/****************************************************************************************\
		|CONTIENE LA CLAVE DE LA BASE DE DATOS CORREPONDIENTE AL USUARIO UTILIZADO EN LA CONEXI�N|
		\****************************************************************************************/
		private $contrasena     = "1234";
		/************************************************\
		|CONTIENE EL ID DE CONEXI�N DEVUELTO POR LA CLASE|
		\************************************************/
		private $idConexion     = "";
		/************************************************************************************************\
		...
		/***********************************************************\
		|CONTIENE EL C�DIGO DE ERROR QUE RETORN� LA ULTIMA SENTENCIA|
		\***********************************************************/
		public $error           = "";
		/*****************************************************************\
		|CONTIENE LA DESCRIPCI�N DEL ERROR QUE RETORN� LA ULTIMA SENTENCIA|
		\*****************************************************************/
		public $errno           = 0;
		/****************************************************************\
		|CONTIENE LA LISTA DE PAR�METROS PAR EJECUTAR UN STORED PROCEDURE|
		...
		private function concectarMySql(){
			/***************************************************************\
			|ESTE M�TODO PERMITE ESTABLECER LA CONEXI�N CON LA BASE DE DATOS|
			\***************************************************************/
			#    echo("M�todo: concectarMySql");
			...
			/***************************************************************\
			|AL CONECTAR CON LA BASE DE DATOS ADEM�S SETEO LA BASE CON CUAL |
			|TRABAJAR                                                       |
			\***************************************************************/
		...
		function seleccionarBaseDeDato(){
			/**********************************************************\
			|ESTE M�TODO PERMITE ESTABLECER LA LA BASE ACTIVA PARA ESTA|
			|CONEXI�N                                                  |
			\**********************************************************/
			#    echo("M�todo: seleccionarBaseDeDato");
		...
		function procesarSql(){
			...
			|EN CASE QUE FUERA UNA CONSULTA DE SELECCI�N               |
			\**********************************************************/
			#   echo("M�todo: procesarSql");
		...
		function cerrarConexion(){
			/****************************************************************\
			|ESTE M�TODO CIERRA LA CONEXI�N CON LA BASE DE DATOS Y LIBERAR LA|
			|MEMORIA UTILIZADA EN EL SERVIDOR POR DICHA CONEXI�N             |
			\****************************************************************/
			/******************************\
			|LIBERAR CONJUNTO DE RESULTADOS|
			\******************************/
			#    echo("M�todo: cerrarConexion");
			...
			|CERRAR LA CONEXION|
			\******************/
			mysqli_close( $this->idConexion ) or die( "Error al intentar cerrar la conexi�n: " . mysqli_connect_error( $this->idConexion ) );
		}	#	function cerrarConexion()

		private function cargarArrayObjetos(){
			/***********************************************************\
			|ESTE M�TODO LEE EL ID DE LA CONSULTA Y RETORNA UN OBJETO EL|
			|CUAL ASIGNO AL ARRAY DE SALIDA PARA PODER SER EXPLOTADO    |
			\***********************************************************/
			#    #    echo("M�todo: cargarArray");
			$j = 0;
